...
class CategoriesWidget extends StatelessWidget {
  ...
  final String email;
  const CategoriesWidget({Key? key, required this.fullName, required this.email}) : super(key: key);
        ...
        children: [
          ...
          GestureDetector(
            child: Container(
              ...
              child: Center(child: Text('View all categories', style: TextStyle(fontSize: 14.0, color: Colors.blue, fontWeight: FontWeight.bold), textAlign: TextAlign.center),),
            ),
            onTap: () {
              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => BrowseCategoryPage(fullName: fullName, email: email)));
            },
          ),
